...
# #   --project-name $CODEBUILD_NAME \
# #   --filter-groups '[[{"type": "EVENT","pattern": "PUSH"}, 
# #     {"type": "HEAD_REF", "pattern": "^refs/heads/main$"}, {"type": "HEAD_REF", "pattern": "^refs/heads/develop$"}]]' \
# #   || true

# # Multi-group (PUSH + PR optional)
# aws codebuild create-webhook \
#   --region $AWS_REGION \
#   --project-name $CODEBUILD_NAME \
#   --filter-groups \
#     '[[{"type":"EVENT","pattern":"PUSH"},{"type":"HEAD_REF","pattern":"^refs/heads/(main|develop)$"}]]' \
#   || true
